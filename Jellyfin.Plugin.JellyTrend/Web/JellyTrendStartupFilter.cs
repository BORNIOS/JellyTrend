...
{
    /// <summary>
    /// Wraps the application builder so <see cref="ScriptInjectionMiddleware"/> runs at the front of the pipeline.
    /// </summary>
    /// <param name="next">The next startup filter configuration action.</param>
    /// <returns>The wrapped configuration action.</returns>
